...
namespace SmartSchool.API.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>().Property(o => o.Id).ValueGeneratedOnAdd().UseIdentityColumn();
            ...
            builder.Entity<Disciplina>().Property(o => o.Id).ValueGeneratedOnAdd().UseIdentityColumn();
            ...
            builder.Entity<Aluno>().Property(o => o.Id).ValueGeneratedOnAdd().UseIdentityColumn();
